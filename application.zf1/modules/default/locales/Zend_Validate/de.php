 ...
 */
return array(
    // Company_Validate_Compare
    "The values do not match" => "Die Eingaben stimmen nicht überein!",
    
    // Company_Validate_LinkUrl
    "The value is not a valid URL. Must start with http(s)://" => "Die Eingabe ist keine gültige URL. Muss mit http(s):// beginnen",
    
    // Company_Validate_StringMaxHtml
    "The text is too long, please shorten!" => "Der Text ist zu lang, bitte kürzen!",
