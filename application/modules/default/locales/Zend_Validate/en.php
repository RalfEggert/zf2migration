...
return array(
    ...
    "The value is not a valid URL. Must start with http(s)://" => "The value is not a valid URL. Must start with http(s)://",
    
    // Company_Validate_StringMaxHtml
    "The text is too long, please shorten!" => "The text is too long, please shorten!",
